...
import pom.nn.p03.Graphics.LineCharts.LineChart as lineChart
import pom.nn.p03.util.FileUtil as file_util

RESULT_DATA = 'p03/output/'
...
def loss(
    ...
    :param ylabel_name: y-axis label.
    """
    path = RESULT_DATA + experiment["training_file_name"] + sub_directory_name
    file_util.make_dir_if_not(path)
    plot_name = "loss"
