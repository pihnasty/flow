"""Module for creating graph image of conveyor from 2016_KaKrZiJuJaPi_1"""
...
def route_2016_KaKrZiJuJaPi_1(param, change_canvas_size_=False, paste_c_k=False):
    ...
    graph.node('lu', pos='0.0, 0.88!', label='')
    graph.node('rd', pos='1.0, -0.05!', label='')

    graph.node('tA183', pos='0.85, 0.04!')
    graph.node('hA183', pos='0.72, 0.04!')
    graph.edge('tA183', 'hA183', taillabel='<C<SUB>1</SUB>>',
               labeldistance='1', labelangle='320')
    ...
    graph.edge('tL52', 'hL52', taillabel='<C<SUB>3</SUB>>',
               labeldistance='3', labelangle='20')
    ...
    graph.edge('tL1031', 'hL1031', taillabel='<C<SUB>5</SUB>>',
               labeldistance='1.7', labelangle='330')
    ...
    graph.edge('tL161', 'hL161', taillabel='<C<SUB>6</SUB>>',
               labeldistance='3.5', labelangle='340')
    ...
    graph.edge('tP9c', 'hP9c', taillabel='<C<SUB>7</SUB>>',
               labeldistance='1.5', labelangle='320')
    ...
    graph.edge('tP8c', 'hP8c', taillabel='<C<SUB>8</SUB>>',
               labeldistance='1.9', labelangle='330')
    ...
    graph.edge('tP5ac', 'hP5ac', taillabel='<C<SUB>13</SUB>>',
               labeldistance='1.', labelangle='120')
    ...
    graph.node('tP4c', pos='0.06, 0.34!')
    graph.node('hP4c', pos='-0.06, 0.34!')
    graph.edge('tP4c', 'hP4c', taillabel='<C<SUB>14</SUB>>',
               labeldistance='1.7', labelangle='320')
    graph.node('tP46', pos='0.06, 0.345!')
    graph.node('hP46', pos='0.06, 0.34!')
    graph.edge('tP46', 'hP46', arrowhead='normal')
    graph.node('tP3c', pos='-0.06, 0.34!')
    graph.node('hP3c', pos='-0.175, 0.34!')
    graph.edge('tP3c', 'hP3c', taillabel='<C<SUB>15</SUB>>',
               labeldistance='1.7', labelangle='320')
    graph.node('hP36', pos='-0.076, 0.34!')
    graph.node('tP36', pos='-0.076, 0.3405!')
    graph.edge('tP36', 'hP36', arrowhead='o')
    graph.node('tP2c', pos='-0.175, 0.34!')
    graph.node('hP2c', pos='-0.28, 0.34!')
    graph.edge('tP2c', 'hP2c', taillabel='<C<SUB>16</SUB>>',
               labeldistance='1.7', labelangle='320')
    graph.node('hP15_4', pos='-0.22, 0.34!')
    graph.node('tP15_4', pos='-0.22, 0.3405!')
    graph.edge('tP15_4', 'hP15_4', arrowhead='o')
    graph.node('hP6_2', pos='-0.25, 0.34!')
    graph.node('tP6_2', pos='-0.25, 0.3405!')
    graph.edge('tP6_2', 'hP6_2', arrowhead='o')
    graph.node('tP1c', pos='-0.28, 0.34!')
    graph.node('hP1c', pos='-0.4, 0.34!')
    graph.edge('tP1c', 'hP1c', taillabel='<C<SUB>17</SUB>>',
               labeldistance='1.7', labelangle='320')
    graph.node('hP1', pos='-0.4, 0.34!')
    graph.node('tP1', pos='-0.4, 0.3405!')
    graph.edge('tP1', 'hP1', arrowhead='normal')
    graph.node('hC106', pos='0.025, 0.34!')
    graph.node('tC106', pos='0.15, 0.565!')
    graph.edge('tC106', 'hC106', taillabel='<C<SUB>18</SUB>>',
               labeldistance='3', labelangle='25')
    graph.node('hP18_2', pos='0.145, 0.56!')
    graph.node('tP18_2', pos='0.135, 0.5609!')
    graph.edge('tP18_2', 'hP18_2', arrowhead='o')
    graph.node('hP8_2', pos='0.09, 0.46!')
    graph.node('tP8_2', pos='0.08, 0.465!')
    graph.edge('tP8_2', 'hP8_2', arrowhead='o')
    graph.node('hC1701', pos='0.15, 0.565!')
    graph.node('tC1701', pos='0.175, 0.65!')
    graph.edge('tC1701', 'hC1701', taillabel='<C<SUB>19</SUB>>',
               labeldistance='1.5', labelangle='320',
               arrowhead='normal')
    graph.node('hP3', pos='0.17, 0.64!')
    graph.node('tP3', pos='0.165, 0.6405!')
    graph.edge('tP3', 'hP3', arrowhead='o')
    graph.node('hK85', pos='0.085, 0.45!')
    graph.node('tK85', pos='0.01, 0.475!')
    graph.edge('tK85', 'hK85', taillabel='<C<SUB>20</SUB>>',
               labeldistance='0.8', labelangle='270')
    graph.node('hP13_2', pos='0.02, 0.474!')
    graph.node('tP13_2', pos='0.02, 0.4755!')
    graph.edge('tP13_2', 'hP13_2', arrowhead='o')
