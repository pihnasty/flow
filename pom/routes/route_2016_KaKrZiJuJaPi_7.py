"""Module for creating graph image of conveyor from 2016_KaKrZiJuJaPi_7"""
...
def route_2016_KaKrZiJuJaPi_7(param, change_canvas_size_=False, paste_c_k=False):
    ...
    graph.node('rd', pos='0.85, 0.1!', label='')

    graph.node('hE3', pos='0.6, 0.2!')
    graph.node('tE3', pos='0.6, 0.53!')
    graph.edge('tE3', 'hE3', taillabel='<C<SUB>1</SUB>>',
               labeldistance='6.5', labelangle='7')
    graph.node('hP23', pos='0.6, 0.51!')
    graph.node('tP23', pos='0.599, 0.51!')
    graph.edge('tP23', 'hP23', arrowhead='o')
    graph.node('hP15', pos='0.6, 0.41!')
    graph.node('tP15', pos='0.599, 0.41!')
    graph.edge('tP15', 'hP15', arrowhead='o')
    graph.node('hP7', pos='0.6, 0.35!')
    graph.node('tP7', pos='0.599, 0.35!')
    graph.edge('tP7', 'hP7', arrowhead='o')
    graph.node('hRR', pos='0.8, 0.2!')
    graph.node('tRR', pos='0.4, 0.2!')
