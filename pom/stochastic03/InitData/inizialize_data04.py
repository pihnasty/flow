...
from pom.stochastic03.utils.Constants import ERR_APPROX_INIT_DIMLESS_FLOW_LINE, \
    ...
    INIT_DATA_DIMENSIONLESS_RESULT, G_G2, RESULT_DATA, NUMBER_OF_SPECTRUM_SPLIT_PARTS, \
    INIT_DIMENSIONLESS_FLOW_LINE, INIT_DIMENSIONLESS_FLOW_HIST, INIT_DIMENSIONLESS_FLOW_Q_Q, \
    INIT_CORRELATION_LINE, PERIOD, \
    PLOT_PARAMETERS, Y_LABEL_NAME, MODEL_PARAMETERS, APPROXIMATE_TYPE, NUMBER_OF_INTERVALS, INIT_FLOW_LINE, \
    INIT_FLOW_HIST, DIMENSIONLESS_TYPE, INIT_DATA_DIMENSIONLESS_RESULT__ERROR_ESTIMATE, \
    NUMBER_OF_INITIAL_INTERVALS_TO_GENERATE, NUMBER_OF_HARMONICS, HARMONIC_VALUES_HIST
...
#                , "color_line_set": { 0:'k',  1:'k',  2:'b',  3:'g',  4:'y',  5:'r'}
    ...
    "2023_05_23_dataset_2018_Buy_first_flow": {
        "project_structure": {
            ...
            , "result_data_structure": {
                "result_data": "resultData"
                , "initial_data_result": "initial"
                , INIT_DATA_DIMENSIONLESS_RESULT: "initial_dimensionless"
                , "initial_data_dimensionless_result2": "initial_dimensionless2"
                , G_G2: "g_g2"
                , "gamma_optimal_s": "gamma_optimal_s"
                , "test_theory_cor_function_exp": "test_theory_cor_function_exp"
    ...
    "2023_06_29_dataset_2021_KaKr": {
        "project_structure": {
            "file_name": "dataset_2021_KaKr.csv"
            , "files_category": "files"
            , "result_data_structure": {
                "result_data": "resultData"
                , "initial_data_result": "initial"
                , INIT_DATA_DIMENSIONLESS_RESULT: "initial_dimensionless"
                , INIT_DATA_DIMENSIONLESS_RESULT__ERROR_ESTIMATE: "initial_dimensionless/error_estimate"
                , "initial_data_dimensionless_result2": "initial_dimensionless2"
                , G_G2: "g_g2"
                , "gamma_optimal_s": "gamma_optimal_s"
                , "test_theory_cor_function_exp": "test_theory_cor_function_exp"
        ...
        ,MODEL_PARAMETERS: {
            APPROXIMATE_TYPE : ApproximateType.STOCHASTIC_TELEGRAPH_WAVE_FIXED_SEPARATED_INTERVAL
            , NUMBER_OF_INITIAL_INTERVALS_TO_GENERATE : 8
            , NUMBER_OF_INTERVALS : 100 # the number of uniform intervals into which the total research time is divided
            , DIMENSIONLESS_TYPE : DimensionlessType.STD_TIME_M1_1
        }
        , PERIOD: 10
        , "load_period": 10
        , "correlation_addition_time": 0.0
        ...
        , PLOT_PARAMETERS: {
            ...
            , INIT_FLOW_HIST: {
                ...
                , "y_size_plot": 60.0  # 72.0  #120.0
                , "border_adjustment": {
                    "left": 0.20, "right": 0.92, "top": 0.92, "bottom": 0.17
                }
            }
    ...
    "2023_07_29_dataset_2020_ZeYaWuWa": {
        "project_structure": {
            "file_name": "dataset_2020_ZeYaWuWa.csv"
            , "files_category": "files"
            , "result_data_structure": {
                RESULT_DATA: "resultData"
                , "initial_data_result": "initial"
        ...
        , MODEL_PARAMETERS: {
            APPROXIMATE_TYPE: ApproximateType.SPECTRUM_WITH_MORE_REALIZATION
            , NUMBER_OF_INITIAL_INTERVALS_TO_GENERATE: 8
            , NUMBER_OF_INTERVALS: 1024 # the number of uniform intervals into which the total research time is divided
            , DIMENSIONLESS_TYPE: DimensionlessType.STD_TIME_M1_1
        ...
        , "correlation_addition_time": 0.0
        , "number_of_harmonics": 30
        , "correlation_tau": 0.3  # no use. It moves to MODEL_PARAMETERS.
        ...
        , PLOT_PARAMETERS: {
            ...
            , INIT_DIMENSIONLESS_FLOW_LINE: {
                "visual_line_set": {"0": 0, "1": 1, "2": 2, "3": 1, "4": 1, "5": 1}
                , "color_line_set": {0: 'k', 1: 'k', 2: 'k', 3: 'r', 4: 'k', 5: 'k'}
                , "fontsize": 9
                , "alpha_main": 1.0
                , "alpha_grid": 0.7
                , "color": "black"
            ...
            , INIT_DIMENSIONLESS_FLOW_Q_Q: {
                "visual_line_set": {"0": 0, "1": 1, "2": 2, "3": 2, "4": 1, "5": 1}
                , "color_line_set": {0: 'k', 1: 'k', 2: 'r', 3: 'k', 4: 'k', 5: 'k'}
                , "fontsize": 16
                , "alpha_main": 1.0
                , "alpha_grid": 0.7
            ...
            , TAU_SEQUENCE_HIST: {
                ...
                , "count_of_intervals_xi2": 10
                , "fontsize": 9
                , "x_label_name": r'$\Theta$'
                , "y_label_name": r'f($\Theta$)'
                , "alpha": 0.7
                , "rwidth": 0.7
                , "x_size_plot": 85.0  # 86.5  #160.5
                , "y_size_plot": 60.0  # 72.0  #120.0
