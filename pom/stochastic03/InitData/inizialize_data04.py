...
from constants.flow_constants import CUSTOM_FLOW_VALUE, CUSTOM_TIME_VALUE, MODEL_PARAMETERS, APPROXIMATE_TYPE, \
...
from pom.stochastic03.utils.Constants import ERR_APPROX_INIT_DIMLESS_FLOW_LINE, \
    ...
    PLOT_PARAMETERS, Y_LABEL_NAME, INIT_FLOW_LINE, \
    INIT_FLOW_HIST, INIT_DATA_DIMENSIONLESS_RESULT__ERROR_ESTIMATE, \
...
experiments = {
    "2023_07_29_dataset_2020_ZeYaWuWa": {
        "project_structure": {
            "file_name": "_dataset_2020_ZeYaWuWa.csv"
        ...
        , MODEL_PARAMETERS: {
            ...
            , DIMENSIONLESS_TYPE: DimensionlessType.CUSTOM_TIME_CUSTOM
            , CUSTOM_FLOW_VALUE: 10.7 # x_max * speed = x_average / 0.8 * speed = 8.91 / 0.83333333 * 1.0 = 10.7
            , CUSTOM_TIME_VALUE: 7.0
